...
// Entry rule entryRuleOCL
entryRuleOCL returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getOCLRule()); }
	 iv_ruleOCL=ruleOCL 
	 { $current=$iv_ruleOCL.current; } 
	 EOF 
;

// Rule OCL
ruleOCL returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		{ 
	        newCompositeNode(grammarAccess.getOCLAccess().getImportsXImportSectionParserRuleCall_0_0()); 
	    }
		lv_imports_0_0=ruleXImportSection		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOCLRule());
	        }
       		set(
       			$current, 
       			"imports",
...
(
		{ 
	        newCompositeNode(grammarAccess.getOCLAccess().getContextsContextParserRuleCall_1_0()); 
	    }
		lv_contexts_1_0=ruleContext		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOCLRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getContextAccess().getTypeJvmParameterizedTypeReferenceParserRuleCall_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getContextAccess().getOperationsOperationParserRuleCall_3_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getOperationAccess().getSignatureOperationSignatureParserRuleCall_0_0()); 
	    }
		lv_signature_0_0=ruleOperationSignature		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getOperationAccess().getConstraintsConstraintParserRuleCall_2_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getOperationSignatureAccess().getParamsFullJvmFormalParameterParserRuleCall_2_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getOperationSignatureAccess().getRightParenthesisKeyword_3());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getOperationSignatureAccess().getTypeJvmTypeReferenceParserRuleCall_4_0()); 
	    }
...
(
    { 
        newCompositeNode(grammarAccess.getConstraintAccess().getPreConstraintParserRuleCall_0()); 
    }
    this_PreConstraint_0=rulePreConstraint
    { 
        $current = $this_PreConstraint_0.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getConstraintAccess().getPostConstraintParserRuleCall_1()); 
    }
    this_PostConstraint_1=rulePostConstraint
    { 
        $current = $this_PostConstraint_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
// Entry rule entryRulePreConstraint
entryRulePreConstraint returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPreConstraintRule()); }
	 iv_rulePreConstraint=rulePreConstraint 
	 { $current=$iv_rulePreConstraint.current; } 
	 EOF 
;

// Rule PreConstraint
rulePreConstraint returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='pre' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getPreConstraintAccess().getPreKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getPreConstraintAccess().getBodyXExpressionParserRuleCall_1_0()); 
	    }
		lv_body_1_0=ruleXExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getPreConstraintRule());
	        }
       		set(
       			$current, 
       			"body",
...
// Entry rule entryRulePostConstraint
entryRulePostConstraint returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getPostConstraintRule()); }
	 iv_rulePostConstraint=rulePostConstraint 
	 { $current=$iv_rulePostConstraint.current; } 
	 EOF 
;

// Rule PostConstraint
rulePostConstraint returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='post' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getPostConstraintAccess().getPostKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getPostConstraintAccess().getBodyXExpressionParserRuleCall_1_0()); 
	    }
		lv_body_1_0=ruleXExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getPostConstraintRule());
	        }
       		set(
       			$current, 
       			"body",
